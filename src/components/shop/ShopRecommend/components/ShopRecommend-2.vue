<template>
  <div>
    <div class="container">
      <div class="items">
        <div class="item" v-for="item in ShowOnepiecesItems" :key="item.name">
        ...
        <div class="item" v-show="recommend_show_4">
          <a @click="toProduct_N('029')"
            ><div class="img-box">
              <div class="img-con">
                <img src="@/assets/img/029-01.jpg" alt="" />
              </div>
            </div>

            <div class="name"><p>異素材切替ワンピース</p></div>
            <div class="type"><p>ボトムス/スカート</p></div>
            <div class="price"><p>￥1,980税込</p></div></a
          >
        </div>
        <div class="item" v-show="recommend_show_3">
          <a @click="toProduct_N('030')"
            ><div class="img-box">
              <div class="img-con">
                <img src="@/assets/img/030-01.jpg" alt="" />
              </div>
            </div>

            <div class="name"><p>デニムシャツワンピース</p></div>
            <div class="type"><p>ボトムス/スカート</p></div>
            <div class="price"><p>￥2,480税込</p></div></a
          >
        </div>
      </div>
    </div>
...
import { OnepiecesItems } from '@/data/shop/OnepiecesItems'
export default defineComponent({
  setup() {
    ...
    const ShowOnepiecesItems = OnepiecesItems.filter((item) => {
      return item.id !== '029' && item.id !== '030'
    })
